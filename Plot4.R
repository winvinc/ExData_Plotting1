...
par(mfrow = c(2,2))
with(use_data, {
  plot(use_data$Datetime,as.numeric(use_data$Global_active_power), type = "l", xlab="", ylab="Global Active Power (kilowatts)")
  plot(use_data$Datetime, as.numeric(use_data$Voltage), type = "l",ylab = "Voltage", xlab = "datetime")
  ...
  plot(use_data$Datetime,as.numeric(use_data$Global_reactive_power), type = "l", ylab = "Global_reactive_power", xlab = "datetime")
})
